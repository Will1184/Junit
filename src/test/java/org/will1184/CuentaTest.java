...
import org.will1184.exceptions.DineroInsuficienteException;
import org.will1184.models.Banco;
import org.will1184.models.Cuenta;
...
class CuentaTest {
    ...
    class CuentaTestNombreSaldo{
        ...
        void testNombreCuenta() {
            ...
            assertTrue(real.equals("Andres"), () -> "Nombre cuenta esperada deber ser igual a la real");
        }
            @Test
            @DisplayName("el saldo, que no se null, mayor que cero, valor esperado.")
    ...
    class CuentaOperacionesTest{
        ...
        @RepeatedTest(value = 5, name = "{displayName} - Repeticion numero {currentRepetion} de {totalRepetions}")
        void testDebitoCuentaRepetir(RepetitionInfo info){
            if (info.getCurrentRepetition()==3){
                System.out.println("Estamos en la repeticioon "+ info.getCurrentRepetition());
            }
            cuenta.debito(new BigDecimal(100));
            assertNotNull(cuenta.getSaldo());
            assertEquals(900,cuenta.getSaldo().intValue());
        ...
        @Tag("param")
        @Nested
        class  PruebaParametrizadasTest{
        ...
        static List<String> montoList(){ return Arrays.asList("100","200","300","500","700","1000.12345");}
